...
<!-- TODO: REPLACE ALL `graph-pathfinding-algorithms`, `Cost Finding Algorithms`, `Algorithms for Bellman Ford, Dijkstra, Floyd, Kruskal and Prims`. FILL "about the project" and uncomment hidden sections if needed -->
<a name="readme-top"></a>
...
<br />
<div align="center">
  <!-- <a href="https://github.com/InfiniteLoopify/graph-pathfinding-algorithms">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a> -->
<h3 align="center">Cost Finding Algorithms</h3>

  <p align="center">
    Algorithms for Bellman Ford, Dijkstra, Floyd, Kruskal and Prims
    <br />
    <a href="https://github.com/InfiniteLoopify/graph-pathfinding-algorithms"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <!-- <a href="https://github.com/InfiniteLoopify/graph-pathfinding-algorithms">View Demo</a>
    · -->
    <a href="https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
![Screenshot](images/screenshot-graph.png)
...
See the [open issues](https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/InfiniteLoopify/graph-pathfinding-algorithms](https://github.com/InfiniteLoopify/graph-pathfinding-algorithms)
...
[contributors-shield]: https://img.shields.io/github/contributors/InfiniteLoopify/graph-pathfinding-algorithms.svg?style=for-the-badge
[contributors-url]: https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/InfiniteLoopify/graph-pathfinding-algorithms.svg?style=for-the-badge
[forks-url]: https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/network/members
[stars-shield]: https://img.shields.io/github/stars/InfiniteLoopify/graph-pathfinding-algorithms.svg?style=for-the-badge
[stars-url]: https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/stargazers
[issues-shield]: https://img.shields.io/github/issues/InfiniteLoopify/graph-pathfinding-algorithms.svg?style=for-the-badge
[issues-url]: https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/issues
[license-shield]: https://img.shields.io/github/license/InfiniteLoopify/graph-pathfinding-algorithms.svg?style=for-the-badge
[license-url]: https://github.com/InfiniteLoopify/graph-pathfinding-algorithms/blob/master/LICENSE
